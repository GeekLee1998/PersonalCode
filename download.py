...
parser.add_argument('datasets', metavar='N', type=str, nargs='+', choices=['celebA', 'lsun', 'mnist', 'emnistdigits', 'fashionmnist', 'kmnist', 'cifar10'],
           help='name of dataset to download [celebA, lsun, mnist, emnistdigits, fashionmnist, kmnist, cifar10]')
...
def download_cifar_10(dirpath):
  data_dir = os.path.join(dirpath, 'cifar10')
  # if os.path.exists(data_dir):
  #   print('Found Cifar-10 - skip')
  #   return
  # else:
  #   os.mkdir(data_dir)
...
if __name__ == '__main__':
  ...
  if any(name in args.datasets for name in ['Cifar10', 'cifar10', 'CIFAR10', 'cifar-10', 'CIFAR-10']):
    download_cifar_10('./data')
